  ...
  <div class="flex flex-col gap-5">
    ...
    <Card class="py-3 px-4 flex-col gap-5">
        ...
        <div class="w-full">
          ...
          <input type="text" name="ton" id="ton" 
        ...
        <div class="w-full mt-0.5 grid justify-items-center">
          ...
          >
          <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24"><path fill="none" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2.5" d="M11 8L7 4m0 0L3 8m4-4v16m6-4l4 4m0 0l4-4m-4 4V4"/></svg>
        </div>
        </div>
        <div class="w-full">
          <div class="relative mt-0.5 rounded-md shadow-sm">
          ...
          <input type="text" name="ctmi" id="ctmi" 
            class="flex w-full p-2 text-sm text-zinc-100 bg-zinc-900 rounded-xl focus:outline-none h-10"
            placeholder="0.00" />
          </div>
        </div>
        <div class="w-full mt-0.5 grid justify-items-center">
          <button class="group relative h-10 w-32 overflow-hidden rounded-2xl bg-green-500 text-lg font-bold text-white">
            Buy now!*
            <div class="absolute inset-0 h-full w-full scale-0 rounded-2xl transition-all duration-300 group-hover:scale-100 group-hover:bg-white/30"></div>
          </button>
        </div>
        <div class="w-full my-1 text-sm text-white">
          <h4>* Can also send TON to UQCV3YdlxazBZpIeb-7426nun1B-yyMrAtUNdl5zubWYfRQv or to cryptomi.ton from a decentralised wallet</h4>
    ...
    <Card class="py-3 px-4 flex-col gap-5 text-white">
		...
		<p class="text-neutral-500 text-base mt-3">
