  ...
  <div v-else class="flex flex-col gap-3">
    ...
    <div class="flex w-full gap-1 mt-4">
      <div class="flex bg-neutral-800 rounded-xl items-center w-full justify-between text-zinc-300">
        <div class="flex gap-1 shrink-0 items-center bg-gray-900 h-full p-1 rounded-xl pe-2 me-2">
        ...
        <div
          ...
          class="text-xs flex gap-1 shrink-0 px-2 bg-green-600 text-zinc-900 rounded-xl p-1 me-2"
        >
